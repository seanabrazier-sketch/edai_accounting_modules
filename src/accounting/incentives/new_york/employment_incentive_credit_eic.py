...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        self.main_bol="Yes" if benefit_bol_array.count("Yes")>0 else "No"

        array_value=[0.015,0.02,0.025]
        choose_value=look_up("Yes",benefit_bol_array,array_value)
        sum_val=self.machine+self.construction
        main_array=[sum_val*choose_value if self.main_bol=="Yes" else 0 for i in range(11)]
        main_array[0]=0
        main_array[1]=0
