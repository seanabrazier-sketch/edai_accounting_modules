...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        bol_array=[
            "Yes" if self.promised_jobs>= 1 else "No",
            "Yes" if self.promised_wage>=min_val else "No"
        ]
        self.main_bol="Yes" if bol_array.count("Yes")==2 else "No"
        main_array=[self.promised_jobs*5000 if self.main_bol=="Yes" else 0 for i in range(11)]
        main_array[0]=0
