...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        ## minimum cpaex
        capex_bol_array=[
            "Yes" if self.attraction=="Relocation" and self.promised_cap>=125000 else "No",
            "Yes" if self.attraction=="Expansion" and self.promised_cap>=50000 else "No"
        ]
        capex_bol="Yes" if capex_bol_array.count("Yes")>0 else "No"
        ...
        ## benefit
        array1=[self.total_real_and_personal_prop for i in range(11)]
        array1[0]=0
        array_rate=[0,0.5,0.5,0.5,0.5,0.5,0.4,0.30,0.2,0.1,0]
        array2=[self.property_tax_rate*i*j for i,j in zip(array1,array_rate)]
        array3=[i-j for i,j in zip(self.property_tax,array2)]
        array3[0]=0
        business_earn_bol="Yes"
        local_government_bol="Yes"
        self.main_bol="Yes" if (sector_bol=="Yes" and capex_bol=="Yes" and business_earn_bol=="Yes" and local_government_bol=="Yes")    else "No"
        main_array=array3
