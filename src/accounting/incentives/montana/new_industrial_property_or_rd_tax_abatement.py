...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        self.main_bol="Yes" if sector_requirements.count("Yes")>0 else "No"

        self.year=100 if sector_requirements[-1]=="Yes" else 3
        sum_val=self.construction+self.machine+self.fix
        array1=[sum_val*0.03 for i in range(11)]
        array1[0]=0
        array2=[i*self.property_tax_rate for i in array1]
