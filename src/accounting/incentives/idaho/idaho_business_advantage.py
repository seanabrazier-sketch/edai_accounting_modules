...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
      ...
      fixture=self.capex.amount(property_type=PersonalProperty.FIXTURES,
                                    industry_type=self.pnl_input["industry_type"])
      machinery = self.capex.amount(property_type=PersonalProperty.MACHINERY_AND_EQUIPMENT,
                                    industry_type=self.pnl_input["industry_type"])
      ...
      ## smaller employer growth incentive
      ...
      sales_and_use_tax_array=[0.25*state_local_sale_tax*sum_prop]
      for i in range(10):
      ...
      real_property_improvement_array_2=[0]
      for i in range(10):
