...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        ratio=(promised_capital-800000000)/promised_capital
        # requirement
        requirement_bol_array=[
            "Yes" if  promised_job>=1500 else "No",
            "No",
            "Yes" if promised_capital>=800000000 else 'No'
                               ]
        ...
        for i in range(11):
            ...
            if main_bol=="Yes":
                if i==0:
                    ...
                    main_array.append(property_tax[i]*ratio)
            else:
                main_array.append(0)
