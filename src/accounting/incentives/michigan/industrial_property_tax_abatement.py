...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        distribution_bol_array=[
            "Yes" if self.project_category=="Distribution center"   else "No",
            "No",
            "Yes",
            "Yes"
        ]
        distribution_bol="Yes" if distribution_bol_array.count("Yes")==4 else "No"
        ...
        self.main_bol="Yes" if sector_bol_array.count("Yes")>0 or distribution_bol=="Yes" else "No"
        if self.main_bol=="Yes":
            main_array=self.property_tax
        else:
