...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        self.main_bol="Yes"
        if self.main_bol=="Yes":
            array1=[0.075*min(100000,i)+0.024*(i-100000) for i in self.rd][0:4]
            array1[0]=0
            array2=[]
            for i in range(1,8):
                value=sum(self.rd[i:i+3])/3
                value_50=value*0.5
                value=self.rd[i+3]-value_50
                value=0.175*min(100000,value)+0.056*(value-100000)
                array2.append(value)
