...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        lookup="Manufacturing"
        main_bool="Yes" if high_level_category==lookup else "No"
        ...
        for i in range(year+1):
            ...
            if main_bool=="No":
                ...
                if i==0:
                    df_dict["value"].append(state_local_tax_rate*machinery)
                else:
                    df_dict["value"].append(state_local_tax_rate*self.npv_dicts["Annual capital expenditures option 2"][i])
        self.main_bol=main_bool
