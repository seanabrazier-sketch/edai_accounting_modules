...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        array_val=[
            min([self.machine,30000000])/500000

        ]
        array_val.append(array_val[0]+(self.machine-30000000)/1000000 if self.machine>30000000 else 0)

        minimum_job_bol="Yes" if self.promised_jobs>=sum(array_val) else "No"

        self.main_bol="Yes"
        main_array=[self.machine*0.05125 if self.main_bol=="Yes" else 0 for i in range(11)]
