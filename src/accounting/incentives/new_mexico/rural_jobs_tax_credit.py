...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        tier2_bol="Yes" if self.zone_type_3=="Includes Tier 2 area" else "No"

        tier1_bol="Yes" if self.zone_type_3=="Tier 1 rural" else "No"

        self.main_bol="Yes" if tier1_bol=="Yes" or tier2_bol=="Yes" else "No"

        ## main

        array2=[self.promised_jobs*1000 if tier2_bol=="Yes" else 0 for i in range(11)]
        array2[0]=0
        array1=[self.promised_jobs*1000 if tier1_bol=="Yes" else 0 for i in range(11)]
        array1[0]=0

        main_array=array1 if self.main_bol=="Yes" else array2
