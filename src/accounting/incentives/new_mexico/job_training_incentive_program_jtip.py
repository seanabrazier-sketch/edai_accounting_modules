...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        grant_value=grant_estimates_misc_2_df["Average Cost per trainee"]["New Mexico Job Training Incentive Program"]

        program=self.all_input["workforce_programs_ipj_map"]["Costs to train employee"]

        array1=[self.promised_jobs*grant_value if self.main_bol=="Yes" else 0 for i in range(11)]
        array1[0]=0
        array2=[self.promised_jobs*0.63*program if self.main_bol=="Yes" else 0 for i in range(11)]
        main_array=array1
