...
# Embedded file name: C:\Users\tienn\PycharmProjects\pythonGit\edai_accounting_modules-Tien_Branch\src\accounting\incentives\arkansas\governors_quick_action_closing_fund.py
# Compiled at: 2022-01-12 11:19:04
...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        self.main_bol = 'Yes'
        default_val = 8333
        main_array = [self.promised_jobs * default_val for i in range(11)]
        main_array[0] = 0
