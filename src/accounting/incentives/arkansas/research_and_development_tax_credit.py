...
# Embedded file name: C:\Users\tienn\PycharmProjects\pythonGit\edai_accounting_modules-Tien_Branch\src\accounting\incentives\arkansas\research_and_development_tax_credit.py
...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        array1 = self.rd[0:4]
        array1[0] = 0
        array1 = [i * 0.2 for i in array1]
        array2 = []
        for i in range(4, 11):
            value = self.rd[i] - self.rd[(i - 1)]
            value = value * 0.2
            array2.append(value)
