...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        delaware_strategic_fund=self.all_input["discretionary_incentives_groups"].median()["Incentive per job"]["Delaware Strategic Fund"]
        promised_jobs=self.project_level_inputs["Promised jobs"]
        main_bol="No"
        #main tab
        array=[0]
        array.append(promised_jobs*delaware_strategic_fund if main_bol=="Yes" else 0)
        df_dict["Stategic Fund"]=array
