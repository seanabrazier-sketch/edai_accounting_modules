...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        self.main_bol="Yes" if self.promised_wage>=prevailing else "No"

        program=self.all_input["discretionary_incentives_groups"].median()["Incentive per job"]["North Carolina One Carolina Fund"]
