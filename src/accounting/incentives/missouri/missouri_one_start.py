...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        eligibility_bol="Yes" if eligible_bol_array[0:2].count("Yes")>0 and eligible_bol_array[2:4].count("Yes")==2 else "No"

        #main
        self.main_bol="Yes" if eligible_bol_array[0]=="Yes" or eligible_bol_array[2]=="Yes" else "No"

        if self.main_bol=="Yes":
            main_array=[self.promised_jobs*2000 for i in range(11)]
            main_array[0]=0
        else:
