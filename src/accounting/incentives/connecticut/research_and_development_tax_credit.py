...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        #passing this default_array to other file

        default_array=["Yes","Yes","Yes","not modeled"]
        self.enterprise=default_array
        ## passing to config file in connecticut
    ...
    def rd_lookupup(self,value):
        ...
        return_lookup = ["<$50M", "$50M-$100M", "$101M-$200M", ">$200M"]
        variance=[(i-value)**2 for i in array_lookup]
        min_val=min(variance)
        index_lookup=variance.index(min_val)
        return_val=return_lookup[index_lookup]
        return return_val
