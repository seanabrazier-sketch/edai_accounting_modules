...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        ...
        ## check if county is a 0 or 1 element
        ...
        for i in range(11):
            ...
            if sector_requirements=="No":
                ...
                if i==0:
                    ...
                    df_dict["value1"].append(state_local_sale_tax[i])
                    df_dict["value2"].append(self.npv_dicts["Gross receipts tax"])
                    df_dict["value3"].append(tax_rate*machinary)
        array=df_dict["value1"]
        df_dict["npv"].append(npv(self.pnl_input["discount_rate"],array))
