...
class IncentiveProgram(IncentiveProgramBase):
    ...
    def final_return(self):
        self.main_bol="Yes"
        #comeback since missing incentive discretion amount
        default_val=955
        array1=[self.promised_jobs*self.promised_wage*0.0323 if self.main_bol=="Yes" else 0 for i in range(11)]
        array1[0]=0
        array2=[self.promised_jobs*955 for i in range(11)]
        array2[0]=0
        if self.main_bol=="Yes":
            main_array=array1
        else:
