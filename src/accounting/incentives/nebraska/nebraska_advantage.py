...
class IncentiveProgram(IncentiveProgramBase):
    def __init__(self, **kwargs):
        ...
        avg_salary = kwargs['project_level_inputs']['Promised wages']
        ...
        if avg_salary / prevailing_wages_state <= 0.75:
            self.age_multiple = 0.03
        elif avg_salary / prevailing_wages_state < 1.0:
            self.age_multiple = 0.04
        elif avg_salary / prevailing_wages_state < 1.25:
            self.age_multiple = 0.05
        else:
            self.age_multiple = 0.6
        ...
        print('ratio: {}'.format(avg_salary / prevailing_wages_state))
        print('age multiple: {}'.format(self.age_multiple))
